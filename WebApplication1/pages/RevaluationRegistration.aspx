<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="RevaluationRegistration.aspx.cs"
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-body" id="divCourses" runat="server" visible="false">
                             ...
                             <div class="col-md-12" id="tblSession" runat="server" visible="false">
                                ...
                                <div class="col-md-7 text-center" style="margin-left: -60px; color: red; font-size: 14px; font-weight: bold" id="divNote" runat="server" visible="false">
                                    Note : You can apply revaluation for a maximum of 5 subjects only.
                                </div>
                                ...
                                <div class="col-md-12" id="divAllCoursesFromHist" runat="server" visible="false">
                                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto">
                                        <asp:ListView ID="lvCurrentSubjects" runat="server">
                                            <LayoutTemplate>
                                                <div>
                                                    <h3><label class="label label-default">Subject List for Revaluation</label></h3>
                          ...
                          <%--     <div class="col-md-5 text-center" style="margin-left: 630px; margin-top: -22px;" id="divRegisteredCoursesTotalAmt" runat="server" visible="false">
                                ...
                                <div class="col-md-12" id="divRegCourses" runat="server" visible="false">
                                    ...
                                    <asp:Button ID="btnPayOnline" runat="server" Text="Online Payment" OnClick="btnPayOnline_Click" Visible="false"
                                        ValidationGroup="Submit" OnClientClick="return showPayConfirm();" CssClass="btn btn-outline-info" />
                               
                                    <asp:Button ID="btnChallan" runat="server" Text="Challan Receipt" Visible="false"
                                   OnClientClick="return showChallanConfirm();" OnClick="btnChallan_Click" CssClass="btn btn-outline-info" />
