<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="BulkRegistrationSecondSem.aspx.cs" Inherits="ACADEMIC_BulkRegistration" Title="" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td class="vista_page_title_bar">SECOND SEMESTER BULK COURSE REGISTRATION
                    ...
                    <asp:UpdatePanel ID="updBulkReg" runat="server">
                        <ContentTemplate>
                            ...
                            <table cellpadding="2" cellspacing="2" width="100%">
                                ...
                                <tr style="display: none">
                                    <td style="width: 10%;">
                                        <span class="validstar">*</span>Scheme Type :</td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 35%;">
                                        ...
                                        <asp:Button ID="btnShow" runat="server" OnClick="btnShow_Click"
                                            Text="Show" ValidationGroup="submit" Width="80px" Font-Bold="True" />&nbsp;
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="width: 100%">
                                            <tr>
                                                <td style="width: 50%; vertical-align: top; padding: 5px">
                                                    <asp:Panel ID="pnlStudents" runat="server" Visible="true" Width="98%">
                                                                    ...
                                                                    <table id="tblHead" class="datatable" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                                        <thead>
                                                                            <tr class="header" id="trRow">
                                                                                ...
                                                                                <th style="text-align: left; width: 15%">Roll. No.
                                                                                </th>
                                                                                <th style="text-align: left; width: 25%">Enroll. No.
                                                                                </th>
                                                ...
                                                <td style="width: 50%; vertical-align: top; padding: 5px">
                                                    <asp:Panel ID="pnlCourses" runat="server" Visible="true" Width="98%">
