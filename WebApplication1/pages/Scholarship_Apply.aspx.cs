...
public partial class Scholarship_Apply : System.Web.UI.Page
{
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    {
                        objCommon.DisplayMessage(UpdSch, "This Page Is For Student Login", this.Page);
                        return;
                    }
    ...
    private void binddata()
    {
        ...
        string SP_Name2 = "PKG_ACD_GET_SCHOL_APPLICATION_DETAILS";
        ...
        if (dsStudList.Tables[0].Rows.Count > 0)
        {
            ...
            Panel2.Visible = true;
            LvSchol.DataSource = dsStudList;
            LvSchol.DataBind();
        }
        else
        {
            Panel2.Visible = false;
            LvSchol.DataSource = null;
            LvSchol.DataBind();
        }
     ...
     try
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                docname = idno + "_doc_" + "ScholApplication" + ext;

                int retval = Blob_Upload(blob_ConStr, blob_ContainerName, idno + "_doc_" + "ScholApplication" + "", FileUpload1);
                if (retval == 0)
                {
            ...
            string SP_Name1 = "PKG_ACD_INSERT_SCHOL_APPLICATION_FOR_STUDENT";
            ...
            if (que_out1 == "1")
            {
                objCommon.DisplayMessage(UpdSch, "Record Saved Successfully", this.Page);
                binddata();
                TxtLoanAmt.Text = "";
                TxtLoanReason.Text = "";
                return;
