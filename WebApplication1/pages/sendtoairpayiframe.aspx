<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sendtoairpayiframe.aspx.cs" Inherits="sendtoairpayiframe" %>
...
<body onload="javascript:submitForm()">
    <center>
        <table width="500px;">
            ...
            <tr>
                <td align="center" valign="middle">
                    <form id="Form1" action="https://payments.airpay.co.in/pay/index.php" method="post" runat="server" target="airpayiframe">

                        <input type="hidden" name="currency" value="356" />
                        <input type="hidden" name="isocurrency" value="INR" />
                        <input type="hidden" name="buyerRegistrationNo" value="<%=Request.Form["buyerRegistrationNo"]%>" />
        ...
        <iframe name="airpayiframe" width="800px" height="600px"></iframe>
    </center>
</body>
</html>
