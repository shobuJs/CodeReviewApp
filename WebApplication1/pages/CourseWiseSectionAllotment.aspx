                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="col-12">
                                <div class="row">
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:DropDownList ID="ddlColg" runat="server" TabIndex="1"
                                            AppendDataBoundItems="True" AutoPostBack="True" OnSelectedIndexChanged="ddlColg_SelectedIndexChanged"
                                            ToolTip="Please Select Faculty/School Name." data-select2-enable="true">
                                        </asp:DropDownList>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:DropDownList ID="ddlSession" runat="server" AppendDataBoundItems="true" CssClass="form-control" Font-Bold="True" TabIndex="1" OnSelectedIndexChanged="ddlSession_SelectedIndexChanged" Enabled="false" data-select2-enable="true">
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-12">
                                        ...
                                        <asp:DropDownList ID="ddlProgram" runat="server" AppendDataBoundItems="true" AutoPostBack="True"
                                            ValidationGroup="teacherallot" OnSelectedIndexChanged="ddlProgram_SelectedIndexChanged" data-select2-enable="true">
                                            <asp:ListItem Value="0">Please Select</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="rfvDegree" runat="server" ControlToValidate="ddlProgram"
                                            Display="None" ErrorMessage="Please Select Program" InitialValue="0" ValidationGroup="course">
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:DropDownList ID="ddlScheme" runat="server" AppendDataBoundItems="true" CssClass="form-control"
                                            AutoPostBack="True" OnSelectedIndexChanged="ddlScheme_SelectedIndexChanged" TabIndex="1" data-select2-enable="true">
                                            <asp:ListItem Value="0">Please Select</asp:ListItem>
                                        </asp:DropDownList>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        ...
                                        <asp:DropDownList ID="ddlSem" runat="server" AppendDataBoundItems="True" CssClass="form-control"
                                            AutoPostBack="True" OnSelectedIndexChanged="ddlSem_SelectedIndexChanged" TabIndex="1" data-select2-enable="true">
                                            <asp:ListItem Value="0">Please Select</asp:ListItem>
                                        </asp:DropDownList>
                                    ...
                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                        <div class="label-dynamic">
                                            <sup>* </sup>
                                            <asp:Label ID="lblPACourse" runat="server" Font-Bold="true"></asp:Label>
                                        </div>
                                        <asp:DropDownList ID="ddlCourse" runat="server" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged" TabIndex="1" data-select2-enable="true">
                                            <asp:ListItem Value="0">Please Select</asp:ListItem>
                                        </asp:DropDownList>
                            ...
                            <div class="col-12 btn-footer">
                                <asp:Button ID="btnShow" runat="server" TabIndex="1" Text="Show" ValidationGroup="course"
                                    CssClass="btn btn-outline-info" OnClick="btnShow_Click" />&nbsp;&nbsp;
                               
                                         <asp:Button ID="btnSubmit" runat="server" TabIndex="1" Enabled="false" OnClick="btnSubmit_Click"
                                             Text="Submit" CssClass="btn btn-outline-info" ValidationGroup="course" />
                                <asp:Button ID="btnClear" runat="server" Text="Clear" TabIndex="1" CssClass="btn btn-outline-danger" OnClick="btnClear_Click" />
