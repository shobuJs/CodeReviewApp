<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="~/ACADEMIC/TransfreePreviewVin.aspx.cs" Inherits="ACADEMIC_TransfreePreviewVin" %>       <%--TransfreePreview.aspx.cs---%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   <%-- <link href="../css/ImageViewer.css" rel="stylesheet" />
    ...
    <script type="text/javascript">        //Added By Vinay Mishra on 17/01/2024
        function AlertMsg(confirmMessage) {
            debugger
            var hiddenFieldValue = document.getElementById('ctl00_ContentPlaceHolder1_hdnEval').value;
            if (hiddenFieldValue == null || hiddenFieldValue == "") {
                var ret = confirm('Do you want to send the evaluation result? Please note that it cannot be modified later!');

                if (ret) {
                    return true; // Continue with the button click
                } else {
                    return false; // Cancel the button click
                }
            } else {
                alert('Evaluation Result Already Sent. It Cannot be Modified!');
                return false; // Cancel the button click
            }
        }
    </script>
        ...
        <div class="col-md-12 col-sm-12 col-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Transferer Applicant Preview</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card">
                            <div class="card-header" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true">
                                <span class="title">Offer Acceptance </span>      <%-- Transferee Applicant Confirmation --%>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <ul class="list-group list-group-unbordered">
                                                    <li class="list-group-item"><b>Application No. :</b>
                                                        <a class="sub-label">
                                                            <asp:Label ID="lblRegNo" Font-Bold="true" runat="server"></asp:Label>
                                                        </a>
                                                    </li>
                                                    <li class="list-group-item" style="display: none"><b>Student Name :</b>
                                                        <a class="sub-label">
                                                            <asp:Label ID="lblFirstNameP" Font-Bold="true" runat="server" />
                                                    </li>
                                                    <li class="list-group-item" style="display: none"><b>Gender :</b>
                                                        <a class="sub-label">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <ul class="list-group list-group-unbordered">
                                                    ...
                                                    <li class="list-group-item" style="display: none"><b>Year :</b>
                                                        <a class="sub-label">
                                                            <asp:Label ID="lblYear" Font-Bold="true" runat="server" />
                                                        </a>
                                                    </li>

                                                    <li class="list-group-item" style="display: none"><b>Semester :</b>
                                                        <a class="sub-label">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12" style="display: none">
                                                <ul class="list-group list-group-unbordered">
                                                    <li class="list-group-item"><b>Mobile No. :</b>
                                                        <a class="sub-label">
                                                             <asp:Label ID="lblMobileNoP" Font-Bold="true" runat="server" /></a>
                                                    </li>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-6 col-12">
                                                        <ul class="list-group list-group-unbordered">
                                                            <li class="list-group-item"><b>Discipline :</b>
                                                                <a class="sub-label">
                                                                    <asp:Label ID="lblDiscipline" Font-Bold="true" runat="server" />
                                                                </a>
                                                            </li>
                                                            ...
                                                            <li class="list-group-item"><b>Previous University/School :</b>
                                                                <a class="sub-label">
                                                                    <asp:Label ID="lblPrevUniversity" Font-Bold="true" runat="server" />
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-12">
                                                        <ul class="list-group list-group-unbordered">
                                                            <li class="list-group-item"><b>Faculty/School :</b>
                                                                <a class="sub-label">
                                                            ...
                                                            <li class="list-group-item"><b>Awarding Institute :</b>
                                                                <a class="sub-label">
                                                                    <asp:Label ID="lblAInstitute" Font-Bold="true" runat="server" />
                                                                </a>
                                                            </li>
                                                            <li class="list-group-item"><b>Previous Program :</b>
                                                                <a class="sub-label">
                                                                    <asp:Label ID="lblPrevProgram" Font-Bold="true" runat="server" />
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-12">
                                                        <ul class="list-group list-group-unbordered">
                                                            ...
                                                            <li class="list-group-item"><b>Acceptance Date :</b>
                                                                <a class="sub-label">
                                                                    <asp:Label ID="lblADate" Font-Bold="true" runat="server" />
                                                                </a>
                                                            </li>
                                                            <li class="list-group-item"><b>Apply For Year/Semester :</b>
                                                                <a class="sub-label">
                                                                    <asp:Label ID="lblapplysemester" Font-Bold="true" runat="server" /></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <ul class="list-group list-group-unbordered">
                                                    ...
                                                    <li class="list-group-item" style="display: none"><b>Passport No :</b>
                                                        <a class="sub-label">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <ul class="list-group list-group-unbordered">
                                                    <li class="list-group-item"><b>Middle Name :</b>
                                                        <a class="sub-label">
                                                            <asp:Label ID="lblmiddele" Font-Bold="true" runat="server" /></a>
                                                    </li>
                                                    <li class="list-group-item"><b>Mobile No. :</b>
                                                        <a class="sub-label">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <ul class="list-group list-group-unbordered">
                                                    ...
                                                    <li class="list-group-item" style="display: none"><b>Citizen Type :</b>
                                                        <a class="sub-label">
                                        ...
                                        <div class="row mt-3" runat="server" visible="false">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12" >
                                                <ul class="list-group list-group-unbordered">
                                                    ...
                                                    <li class="list-group-item" style="display:none"><b>District :</b>
                                                        <a class="sub-label">
                                        ...
                                        <div class="row mt-3" runat="server" visible="false">
                                            ...
                                            <div class="form-group col-lg-2 col-md-3 col-6">
                                                ...
                                                <asp:TextBox ID="Txtstudylevel" runat="server" TabIndex="0" CssClass="form-control"
                                                    Enabled="false" />
                                            </div>

                                            <div id="diveducationlast" runat="server" class="mt-3 col-12" visible="false">
                                                            ...
                                                            <asp:ListView ID="lvLevellist" runat="server">
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txtNameOfSchool" runat="server" Text='<%#Eval("SCHOOL_NAME") %>' Enabled="false" TabIndex="1" CssClass="form-control" />
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtAddress" runat="server" Text='<%#Eval("SCHOOL_ADDRESS") %>' Enabled="false" TabIndex="1" CssClass="md-textarea form-control" TextMode="MultiLine" Rows="1" />
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtRegion" Text='<%#Eval("SCHOOL_REGION") %>' runat="server" Enabled="false" TabIndex="1" CssClass="form-control" />
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtYearAttended" Text='<%#Eval("YEAR_ATTENDED") %>' MaxLength="4" Enabled="false" onkeyup="return IsNumeric(this);" runat="server" TabIndex="1" CssClass="form-control" />
                                                                        </td>
                                                                        <td>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <ul class="list-group list-group-unbordered">
                                                    <li class="list-group-item"><b>Previous University/School :</b>
                                                        <a class="sub-label">
                                                            <asp:Label ID="txtpreviousschool" Font-Bold="true" runat="server" /></a>
                                                    </li>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <ul class="list-group list-group-unbordered">
                                                    <li class="list-group-item"><b>Previous Program :</b>
                                                        <a class="sub-label">
                                                            <asp:Label ID="txtxpreviouspgm" Font-Bold="true" runat="server" />
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <div class="card" runat="server" visible="false">
                            ...
                            <div id="collapsefive" class="collapse show">
                                <div class="card-body">
                                    <div>
                                        <asp:UpdateProgress ID="UpdateProgress5" runat="server" AssociatedUpdatePanelID="updapplypgm"
                                    ...
                                    <asp:UpdatePanel ID="updapplypgm" runat="server">
                                        <ContentTemplate>
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-6 col-12 mb-3">
                                                        <ul class="list-group list-group-unbordered">
                                                            <li class="list-group-item"><b>Apply For Year/Semester :</b>
                                                                <a class="sub-label">
                                                                    <asp:Label ID="lblapplysem" Font-Bold="true" runat="server" /></a>
                                                            </li>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 80%">
                                                                            <div class="md-form mb-0" id="divPreference1" runat="server">
                                                                                <asp:DropDownList ID="ddlPrefrence1" runat="server" CssClass="form-control mb-0" data-select2-enable="true" Enabled="false" onchange="return FindData('1');" AppendDataBoundItems="true">
                                                                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                                                </asp:DropDownList>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 80%">
                                                                            <div class="md-form mb-0" id="divPreference2" runat="server">
                                                                                <asp:DropDownList ID="ddlPrefrence2" runat="server" CssClass="form-control mb-0" data-select2-enable="true"  Enabled="false" onchange="return FindData('2');" AppendDataBoundItems="true">
                                                                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                                                </asp:DropDownList>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 80%">
                                                                            <div class="md-form mb-0" id="divPreference3" runat="server">
                                                                                <asp:DropDownList ID="ddlPrefrence3" runat="server" CssClass="form-control mb-0" data-select2-enable="true"  Enabled="false" onchange="return FindData('3');" AppendDataBoundItems="true">
                                                                                    <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                                                </asp:DropDownList>
                                                                            </div>
                                                                        </td>
                        ...
                        <div class="card">
                            <div class="card-header collapsed" data-toggle="collapse" data-target="#collapsefour" aria-expanded="false">
                                <span class="title">Evaluation Result</span>
                                <span class="accicon"><i class="fa fa-angle-down rotate-icon"></i></span>
                            </div>
                            ...
                            <div id="collapsefour" class="collapse show">
                                <div class="card-body">
                                    <div>
                                        <asp:UpdateProgress ID="UpdateProgress4" runat="server" AssociatedUpdatePanelID="updEvalution"
                                            DynamicLayout="true" DisplayAfter="0">
                                            <ProgressTemplate>
                                                <div id="preloader">
                                                    <div class="loader-container">
                                    ...
                                    <asp:UpdatePanel ID="updEvalution" runat="server">
                                        <ContentTemplate>
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="form-group col-lg-3 col-md-6 col-12">
                                                        ...
                                                        <asp:DropDownList ID="ddlevalutionResult" runat="server" TabIndex="1" CssClass="form-control select2 select-click"
                                                            AppendDataBoundItems="True" AutoPostBack="true" OnSelectedIndexChanged="ddlevalutionResult_SelectedIndexChanged"
                                                            ToolTip="Please Select Evalution Result">
                                                            <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                        </asp:DropDownList>

                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ddlevalutionResult"
                                                            ValidationGroup="submitEval" Display="None" ErrorMessage="Please Select Evaluation Result" InitialValue="0" />
                                                    </div>

                                                    <div class="form-group col-lg-3 col-md-6 col-12" runat="server" visible="false" id="evalstatus">
                                                        <div class="label-dynamic">
                                                            <label>Test Recommendation</label>
                                                        </div>

                                                        <asp:RadioButtonList ID="rdiotest" runat="server" TabIndex="13" RepeatDirection="Horizontal" meta:resourcekey="rdoGenderResource1">
                                                    ...
                                                    <div class="form-group col-lg-3 col-md-6 col-12" id="divremarks" runat="server" visible="false">
                                                        <div class="label-dynamic">
                                                            <label>Remarks</label>
                                                        </div>

                                                        <asp:TextBox ID="EvalRemark" runat="server" Width="100%" ToolTip="Please Enter Remarks"
                                                            CssClass="form-control" Placeholder="Please Enter Remarks" TabIndex="0" />
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="col-12 text-center" runat="server" visible="false" id="divEvalResult">
                                                <asp:Label ID="lblStatusREval" runat="server" Text="Evaluation result already sent it cannot be modified !!!" Visible="false" CssClass="text-success h6"></asp:Label>
                                                <br />
                                                <asp:HiddenField ID="hdnEval" runat="server" />
                                                <asp:LinkButton ID="btnSubmitEval" runat="server" ToolTip="Send Evaluation Result" OnClientClick="return AlertMsg(this);"
                                                    CssClass="btn btn-sm btn-outline-info mt-2" OnClick="btnSubmitEval_Click" ValidationGroup="submitEval"
                                                    TabIndex="0">Send Evaluation Result</asp:LinkButton>        <%--"return AlertMsg(this);"--%>

                                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="submitEval"
                        ...
                        <div id="Div48" class="card d-none" runat="server" visible="false">
                        ...
                        <div id="Div49" class="card d-none" runat="server" visible="false">
                            <div class="card-header collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false">
                    ...
                    <asp:UpdatePanel ID="updfinalblock" runat="server">
                        <ContentTemplate>
                            <div id="Div50" class="col-12 mt-4" runat="server" visible="false">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="sub-heading">
                            ...
                            <div class="col-12 btn-footer">
                                ...
                                <asp:LinkButton ID="lnkSendEmail" runat="server" CssClass="btn btn-outline-info" OnClick="lnkSendEmail_Click" ValidationGroup="btnSubmit" Visible="false">Send Admission Confirmation</asp:LinkButton>
        ...
        $(document).ready(function () {
            $("[id*=ddlstatus]").bind("change", function () {
                ...
                if (ddlValue == "1") {
                    ...
                    var td = $("td", $(this).closest("tr"));
                    $("[id*=txtremark]", td).val("Please Re-Upload Document");
                }
                else if (ddlValue == "3") {
                    var td = $("td", $(this).closest("tr"));
