...
public partial class Applicant_Preview : System.Web.UI.Page
{
    ...
    public void binddocumentlist()
    {
        try
        {
            ...
            ds = objdocContr.GetDoclistByAdmin(Convert.ToInt32(Request.QueryString["userno"]));
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Count > 0)
            {
                ...
                cs = (CustomStatus)objDoc.UpdateDocumentStatus(Convert.ToInt32(Request.QueryString["userno"]), docnos, docnames, status, remark, Convert.ToInt32(Session["userno"]));
    ...
    protected void EmailSmsWhatssppSend(int Page_No, string toSendAddre, string Name, string IDNO)
    {
        ...
        {
            UserController objUC = new UserController();
            DataSet dsUserContact = objUC.GetEmailTamplateandUserDetails("", "", IDNO, 012879);
