<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="Scholarship_Apply.aspx.cs" Inherits="Scholarship_Apply" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdSch" runat="server">
        <ContentTemplate>
            <div class="row">
        <div class="col-md-12 col-sm-12 col-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><span>Scholarship Apply </span></h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="col-12 mt-3">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3 col-md-6 col-12">
                                <div class="label-dynamic">
                                    <sup>* </sup>
                                    <label>Requested Scholarship Amount</label>
                                </div>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TxtLoanAmt"
                                    Display="None" ErrorMessage="Please Enter Requested Scholarship Amount." ValidationGroup="Submit"
                            ...
                            <div class="form-group col-lg-3 col-md-6 col-12">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtLoanReason"
                                    Display="None" ErrorMessage="Please Enter Reason for Scholarship." ValidationGroup="Submit"
                                    SetFocusOnError="True"></asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group col-lg-3 col-md-6 col-12">
                                <div class="label-dynamic">
                        ...
                        <table class="table table-striped table-bordered nowrap display" style="width: 100%">
                            <thead class="bg-light-blue">
                                <tr>
                                    ...
                                    <th>Requested Scholarship Amount</th>
                                    <th>Status</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <asp:Panel ID="Panel2" runat="server" Visible="false">
                        <asp:ListView ID="LvSchol" runat="server">
                            <LayoutTemplate>
