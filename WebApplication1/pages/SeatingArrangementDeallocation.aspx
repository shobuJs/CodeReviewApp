<%@ Page Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="SeatingArrangementDeallocation.aspx.cs" Inherits="ACADEMIC_SeatingArrangementDeallocation"
    Title=" " %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            <td class="vista_page_title_bar" style="height: 30px">SEATING ARRANGEMENT - DEALLOCATION
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="rfvCourse" runat="server" ControlToValidate="ddlCourse"
                                ValidationGroup="Submit" Display="None" ErrorMessage="Please Select Course" SetFocusOnError="true"
                                InitialValue="0" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlExTTType" runat="server" AppendDataBoundItems="true" Width="25%"
                                ...
                                OnSelectedIndexChanged="ddlExTTType_SelectedIndexChanged">
                            </asp:DropDownList>
