<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="UploadVIPData.aspx.cs" Inherits="ACADEMIC_UploadVIPData" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
     ...
     <div>
        <asp:UpdateProgress ID="updProg" runat="server" AssociatedUpdatePanelID="updAcademicVIP"
    ...
    <asp:UpdatePanel ID="updAcademicVIP" runat="server">
        <ContentTemplate>
            <div class="row">
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-12 btn-footer">
                                ...
                                <asp:Button ID="btnCancel" runat="server" Text="Cancel" ToolTip="Cancel" CausesValidation="false"
                                    TabIndex="5" CssClass="btn btn-outline-danger" />                         
                                        ...
                                        <asp:ListView ID="lvexcelsheet" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><%# Eval("UA_MOBILE") %></td>
                                                    <td class="text-center"><%# Eval("DEPTNAME") %>
                                                        <asp:HiddenField ID="hdnDeptno" runat="server" />

                                                    </td>
                                                    <td class="text-center"><%# Eval("DESIGNATION") %>
                                                         <asp:HiddenField ID="hdnDesigno" runat="server" />
