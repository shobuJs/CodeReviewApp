...
public partial class ACADEMIC_OLCourseList : System.Web.UI.Page
{
    ...
    private void CheckPageAuthorization()
    {
        if (Request.QueryString["pageno"] != null)
        {
            ...
            {
                Response.Redirect("~/notauthorized.aspx?page=OLCourseList.aspx");
            }
            Common objCommon = new Common();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            CustomStatus cs = (CustomStatus)objFHC.InsertCourseOL(Convert.ToInt32(ddlAlCourse.SelectedValue), CourseName, ShortName, savechkK, hdnvalue, 0, 1, Convert.ToInt32(Session["userno"]), Convert.ToInt32(Session["userno"]));
    ...
    private void BindData()
    {
        try
        {
            ...
            DataSet ds = objFHC.GetCourseOL(Convert.ToInt32(ddlAlCourse.SelectedValue));
            if (ds != null)
            {
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ddlAlCourse.SelectedValue = ds.Tables[0].Rows[0]["OLTYPENO"] == null ? "0" : ds.Tables[0].Rows[0]["OLTYPENO"].ToString();
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        drCurrentRow["Column1"] = ds.Tables[0].Rows[i]["OL_COURSES"];
                        drCurrentRow["Column2"] = ds.Tables[0].Rows[i]["OL_SHORTNAME"];
    ...
    private void BindDataGrades()
    {
        try
        {
            ...
            DataSet ds = objFHC.GetGradesOL(Convert.ToInt32(ddlGrade.SelectedValue));
            if (ds != null)
            {
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
    ...
    protected void btnRemoveGrades_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                CustomStatus cs = (CustomStatus)objFHC.InsertGradesOL(Convert.ToInt32(ddlGrade.SelectedValue), "0", "0", "0", Id, 2, Convert.ToInt32(Session["userno"]), Convert.ToInt32(Session["userno"]));
                if (cs.Equals(CustomStatus.RecordSaved))
                {
    ...
    protected void lnkSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            CustomStatus cs = (CustomStatus)objFHC.InsertGradesOL(Convert.ToInt32(ddlGrade.SelectedValue), GradesName, Gradechk, hiddenvalue, 0, 1, Convert.ToInt32(Session["userno"]), Convert.ToInt32(Session["userno"]));
