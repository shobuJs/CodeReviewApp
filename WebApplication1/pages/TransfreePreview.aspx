<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="TransfreePreview.aspx.cs" Inherits="ACADEMIC_TransfreePreview" %>
        ...
        <div class="col-md-12 col-sm-12 col-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Transferee Applicant Preview</h3>
                </div>
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card">
                            <div class="card-header" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true">
                                <span class="title">Transferee Applicant Confirmation </span>
                                ...
                                <div class="card-body">
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                <ul class="list-group list-group-unbordered">
                                                    ...
                                                    <li class="list-group-item"><b>NIC (National Identity card) :</b>
                                                        <a class="sub-label">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div id="diveducationlast" runat="server" class="mt-3 col-12">
                                    ...
                                    <asp:UpdatePanel ID="updEvalution" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="col-12 text-center">
                                                ...
                                                <br />
                                                <asp:LinkButton ID="btnSubmitEval" runat="server" ToolTip="Send Evaluation Result" OnClientClick="return confirm('Do you like to send the evaluation result? Please note that it cannot be modified later !!!');"
                                                    CssClass="btn btn-sm btn-outline-info mt-2" OnClick="btnSubmitEval_Click" ValidationGroup="submitEval"
                                                    TabIndex="0">Send Evaluation Result</asp:LinkButton>
