<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="OLCourseList.aspx.cs" Inherits="ACADEMIC_OLCourseList" %>
                ...
                <div class="nav-tabs-custom mt-2 col-12" id="myTabContent">
                   <%-- <ul class="nav nav-tabs" role="tablist" id="myTab">
                    ...
                    <ul class="nav nav-tabs dynamic-nav-tabs" role="tablist">
                       <li class="nav-item active" id="divlkAnnouncement" runat="server"><asp:LinkButton ID="lkAnnouncement" runat="server" OnClick="lkAnnouncement_Click" CssClass="nav-link" TabIndex="1">O/L Courses</asp:LinkButton></li>
