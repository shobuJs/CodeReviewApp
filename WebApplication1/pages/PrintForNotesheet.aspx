<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true" CodeFile="PrintForNotesheet.aspx.cs" Inherits="ACADEMIC_REPORTS_PrintForNotesheet" %>
    ...
    <asp:UpdatePanel ID="updpnlExam" runat="server">
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" width="90%">
                <tr>
                    <td class="vista_page_title_bar" style="height: 30px">Registration Status Notesheet
                            ...
                            <fieldset class="fieldset">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_left_text">
                                            <asp:DropDownList ID="ddlCollege" runat="server" AppendDataBoundItems="True" AutoPostBack="True" OnSelectedIndexChanged="ddlCollege_SelectedIndexChanged" Width="273px">
                                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                                            </asp:DropDownList>
                                    ...
                                    <tr>
                                        ...
                                        <td class="form_left_text">
                                            <asp:Button ID="btnShowData" runat="server" Text="Show Data"
                                                ValidationGroup="Show" OnClick="btnShowData_Click" Width="123px" />&nbsp;
                                    <asp:Button ID="btnReport" runat="server" Text="Print Report" ValidationGroup="Show"
