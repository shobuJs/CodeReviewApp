...
public partial class ACADEMIC_REPORTS_PrintMultipleMigrationCard : System.Web.UI.Page
{
    ...
    protected void btnShowData_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objcertMasterController.GetStudentListForMigrationCard(admbatchNo, collegeNo, degreeNo, branchNo);
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!string.IsNullOrEmpty(ids))
            {
                ...
                ShowReport(ids, "Print_MigrationCards", "rptMigrationCertificatefForMultiple.rpt");
        ...
        {
            if (Convert.ToBoolean(Session["error"]) == true)
                objUCommon.ShowError(Page, "Academic_Print_MigrationCards.btnReport_Click --> " + ex.Message + " " + ex.StackTrace);
            else
                objUCommon.ShowError(Page, "Server Unavailable");
        }
    }
