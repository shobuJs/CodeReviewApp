<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMasterPage.master" AutoEventWireup="true"
    CodeFile="SemesterOffer.aspx.cs" Inherits="ACADEMIC_SemesterOffer" %>
  ...
  background-color: #eee !important;
    ...
    <style>
        ...
        *, ::after, ::before {
        ...
        #myTable > tbody > tr:nth-child(1) > td:nth-child(8), #myTable > tbody > tr:nth-child(2) > td:nth-child(8), #myTable > tbody > tr:nth-child(4) > td:nth-child(8) {
            color: #000 !important;
        }

        #myTable > tbody > tr:nth-child(3) > td:nth-child(8), #myTable > tbody > tr:nth-child(5) > td:nth-child(8) {
            color: #000 !important;
        }
    </style>
    <!--=========================-->
    ...
    <script>
        function getVal() {
            ...
            if (document.getElementById("<%=ddlToSessionCopy.ClientID%>").value == "0") {
                if (alertmsg == '') {
                    document.getElementById("<%=ddlToSessionCopy.ClientID%>").focus();
                }
                alertmsg += 'Please Select To Session ';
                ...
                <div class="nav-tabs-custom mt-2 col-12 pb-4" id="myTabContent">
                    <ul class="nav nav-tabs dynamic-nav-tabs" role="tablist">
                        <li class="nav-item active" id="divlkAnnouncement" runat="server">
                            <asp:LinkButton ID="lkProgramOffer" runat="server" OnClick="lkAnnouncement_Click" CssClass="nav-link" TabIndex="1">Semester Offer</asp:LinkButton></li>
                        ...
                        <li class="nav-item" id="divlkReports" runat="server">
                            <asp:LinkButton ID="lkProgramCopy" runat="server" OnClick="lkReports_Click" CssClass="nav-link" TabIndex="2">Semester Copy </asp:LinkButton></li>
                    </ul>
                    ...
                    <div class="tab-pane fade show active" id="divAnnounce" role="tabpanel" runat="server" aria-labelledby="ALCourses-tab">
                        ...
                        <asp:UpdatePanel ID="updGradeEntry" runat="server">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <label> College/School Name</label>
                                                            ...
                                                            <div class="label-dynamic">
                                                                <sup>* </sup>
                                                                <asp:Label ID="ddlSessionName" runat="server" Font-Bold="true"></asp:Label>
                                                            </div>
                                                            <asp:DropDownList ID="ddlSession" runat="server" AppendDataBoundItems="True" CssClass="form-control select2 select-click" TabIndex="3" OnSelectedIndexChanged="ddlSession_SelectedIndexChanged" AutoPostBack="true"
                                                ...
                                                <label> College/School Name</label>
                                                            ...
                                                            <asp:DropDownList ID="ddlColg" runat="server" AppendDataBoundItems="True" TabIndex="4" CssClass="form-control select2 select-click" OnSelectedIndexChanged="ddlColg_SelectedIndexChanged" AutoPostBack="true"
                                                                ToolTip="Please Select Faculty/School">
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-6 col-12" runat="server" visible="false">
                                                            ...
                                                            <asp:DropDownList ID="ddlAdmBatch" runat="server" AppendDataBoundItems="True" TabIndex="5" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlAdmBatch_SelectedIndexChanged" AutoPostBack="true"
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-6 col-12" id="divUGPG" runat="server">
                                                            ...
                                                            <asp:DropDownList ID="ddlProgClassification" runat="server" AppendDataBoundItems="True" TabIndex="6" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlProgClassification_SelectedIndexChanged" AutoPostBack="true"
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-6 col-12" runat="server" id="dvClassification">
                                                            ...
                                                            <asp:DropDownList ID="ddlAwardingInstitute" runat="server" TabIndex="7" AppendDataBoundItems="true" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlClassification_SelectedIndexChanged" AutoPostBack="true"
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-6 col-12" runat="server">
                                                            ...
                                                            <asp:DropDownList ID="ddlSemester" runat="server" TabIndex="8" AppendDataBoundItems="true" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlSemester_SelectedIndexChanged" AutoPostBack="true"
                                                                ToolTip="Please Select Semester" ClientIDMode="Static">
                                                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                            </asp:DropDownList>
                                                ...
                                                CssClass="btn btn-outline-info" OnClientClick="return getVal();" />--%>
                                                    <%--   <asp:Button ID="btnShow" runat="server" Text="Show" ToolTip="Show" OnClick="btnShow_Click" Visible="false"
                                                        CssClass="btn btn-outline-info" OnClientClick="return validateShow()" />--%>
                                                    <asp:LinkButton ID="btnSave" runat="server" ToolTip="Submit" ValidationGroup="submit" OnClientClick="return getVal()" TabIndex="9"
                                                        CssClass="btn btn-outline-info btnX" OnClick="btnSave_Click" Visible="false">Submit</asp:LinkButton>
                                                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" ToolTip="Cancel" CausesValidation="false" TabIndex="10"
                                                                    ...
                                                                    <table class="table table-striped table-bordered nowrap" style="width: 100%;" id="myTable">
                                                                        <thead class="bg-light-blue" style="position: sticky; z-index: 1; top: 0; background: #fff !important; box-shadow: rgba(0, 0, 0, 0.2) 0px 0px 1px;">
                                                                            <tr>
                                                                                ...
                                                                                <th style="width: 15px;">Semester Fees</th>
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtSemesterFees" runat="server" CssClass="form-control" Text='<%#Eval("SEMESTER_FEES") %>' MaxLength="10" Width="80px" ></asp:TextBox>
                                                                        <ajaxToolKit:FilteredTextBoxExtender ID="FilteredTextBoxExtender20" runat="server" TargetControlID="txtSemesterFees"
                                                                    ...
                                                                    <td>
                                                                       ...
                                                                       <br/> <asp:TextBox ID="txtCampus7" runat="server" CssClass="form-control clk-text" Width="65px"
                                                                        ...
                                                                        <br/><asp:TextBox ID="txtCampus7N" runat="server" CssClass="form-control clk-text" Width="65px"
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <br /><asp:TextBox ID="txtCampus8" runat="server" CssClass="form-control clk-text" Width="65px"
                                                                        ...
                                                                        <br /><asp:TextBox ID="txtCampus8N" runat="server" CssClass="form-control clk-text" Width="65px"
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <br /><asp:TextBox ID="txtCampus9N" runat="server" CssClass="form-control clk-text" Width="65px"
                            ...
                            <Triggers>
                                ...
                                <asp:AsyncPostBackTrigger ControlID="ddlAwardingInstitute" />
                            ...
                            <ContentTemplate>
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-12">
                                        <div class="">
                                            <div class="box-header with-border">
                                                <h3 class="box-title"><span>Semester Copy</span></h3>
                                            </div>
                                            ...
                                            <div class="box-body">
                                                <div class="col-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                                            ...
                                                            <asp:DropDownList ID="ddlSessionCopy" runat="server" AppendDataBoundItems="True" TabIndex="3" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlSessionCopy_SelectedIndexChanged" AutoPostBack="true"
                                                                ToolTip="Please Select Session">
                                                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                            </asp:DropDownList>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                                                ControlToValidate="ddlSessionCopy" Display="None" InitialValue="0"
                                                                ErrorMessage="Please Select Session."
                                                                SetFocusOnError="True" ValidationGroup="Show" />

                                                        </div>
                                                        <div id="Div8" class="form-group col-lg-3 col-md-6 col-12" runat="server">
                                                            <div class="label-dynamic">
                                                                <sup>* </sup>
                                                                <asp:Label ID="Label1" runat="server" Font-Bold="true">Semester</asp:Label>
                                                            </div>
                                                            <asp:DropDownList ID="ddlSemesterCopy" runat="server" TabIndex="8" AppendDataBoundItems="true" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlSemesterCopy_SelectedIndexChanged" AutoPostBack="true"
                                                                ToolTip="Please Select Semester">
                                                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                            </asp:DropDownList>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                                                ControlToValidate="ddlSemesterCopy" Display="None" InitialValue="0"
                                                        ...
                                                        <div class="form-group col-lg-3 col-md-6 col-12">
                                                            ...
                                                            <asp:DropDownList ID="ddlToSessionCopy" runat="server" AppendDataBoundItems="True" TabIndex="5" CssClass="form-control" data-select2-enable="true" OnSelectedIndexChanged="ddlToSessionCopy_SelectedIndexChanged" AutoPostBack="true"
                                                                ToolTip="Please Select To Session">
                                                                <asp:ListItem Value="0">Please Select</asp:ListItem>
                                                            </asp:DropDownList>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"
                                                                ControlToValidate="ddlToSessionCopy" Display="None" InitialValue="0"
                                                                ErrorMessage="Please Select To Session."
                                                                SetFocusOnError="True" ValidationGroup="Show" />
                                                        </div>
                                                ...
                                                <div class="col-12 btn-footer" id="div7" runat="server">
                                                    <%--<asp:Button ID="btnSave" runat="server" Text="Submit" ToolTip="Submit" ValidationGroup="submit" OnClick="btnSave_Click"
                                                CssClass="btn btn-outline-info" OnClientClick="return getVal();" />--%>
                                                    <asp:Button ID="btnShowCopy" runat="server" Text="Show" ToolTip="Show" OnClick="btnShowCopy_Click" TabIndex="6" ValidationGroup="Show"
                                                        CssClass="btn btn-outline-info" OnClientClick="return validatetion_show()" />
                                                    <asp:LinkButton ID="lnkSubmit" runat="server" ToolTip="Submit" ValidationGroup="submit" OnClientClick="return getVal()" TabIndex="7"
                                                        CssClass="btn btn-outline-info btnX" OnClick="btnSaveCopy_Click" Visible="false">Submit</asp:LinkButton>
                                                    <asp:Button ID="btnCancelCopy" runat="server" Text="Cancel" ToolTip="Cancel" CausesValidation="false" TabIndex="8"
                                                    ...
                                                    <asp:Panel ID="Panel1" runat="server" Visible="true">
                                                        <asp:ListView ID="lvOfferCopy" runat="server" OnItemDataBound="lvOfferCopy_ItemDataBound1">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td>
                                                                        <asp:CheckBox ID="chkSelect" runat="server" CssClass="clk-box" Enabled="true" /></td>
                                                                    <td>
                                                                        <asp:Label ID="lblDegreeno" runat="server" Text='<%# Bind("DEGREENAME") %>' ToolTip='<%# Bind("DEGREEFULLNAME") %>'
                                                                            Font-Size="9pt" /><span> - </span>
                                                                        <%-- <asp:Label ID="lblBranchno" runat="server" Text='<%# Bind("BRANCH") %>' ToolTip='<%# Bind("BRANCHNO") %>'--%>
                                                                        ...
                                                                        <asp:HiddenField ID="hdnDegreeno" runat="server" Value='<%# Bind("DEGREENO") %>' />
                                                                        <asp:HiddenField ID="hdnBranchNo" runat="server" Value='<%# Bind("BRANCHNO") %>' />
                                                                        <asp:HiddenField ID="CopyStatus" runat="server" Value='<%# Bind("COPY_STATUS") %>' />
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtSemesterFees" runat="server" CssClass="form-control" Enabled="false" Text='<%#Eval("SEMESTER_FEES") %>' MaxLength="10"></asp:TextBox>
                                                                        <ajaxToolKit:FilteredTextBoxExtender ID="FilteredTextBoxExtender20" runat="server" TargetControlID="txtSemesterFees"
                                                                            ValidChars="1234567890." FilterMode="ValidChars" />
                                                                    </td>
                                                                    <td>
    ...
    <script type="text/javascript">
        ...
        function validatetion_show() {
            var id = (document.getElementById("<%=btnShowCopy.ClientID%>"));
             // ShowLoader(id);
             //  ShowLoader('#btnSave');
             ...
             if (document.getElementById("<%=ddlSessionCopy.ClientID%>").value == "0") {
                if (alertmsg == '') {
                    document.getElementById("<%=ddlSessionCopy.ClientID%>").focus();
                }
                alertmsg = 'Please Select Session  ' + ' \n';

            }
            if (document.getElementById("<%=ddlSemesterCopy.ClientID%>").value == "0") {
                 if (alertmsg == '') {
                     document.getElementById("<%=ddlSemesterCopy.ClientID%>").focus();
                }
                alertmsg += 'Please Select Semester' + ' \n';
    ...
    <script type="text/javascript">
        ...
        function Checkvalue(id) {
            if (id.value > 0 || id.value == "") {
                ...
                alert("Campus Semester should be greater  than 0 !");
                id.value = '';
                id.focus();
                return false;
            }
