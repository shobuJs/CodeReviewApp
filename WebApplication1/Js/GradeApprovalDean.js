//===============================================//
// MODULE NAME   : RFC ERP 
// PAGE NAME     : Grade Approval by Program Dean
...
$('#ctl00_ContentPlaceHolder1_ddlAcademicSession').on('change', function (e) { 
    ...
    $.ajax({
        ...
        url : localurl + "Exam/GradeApprovalProgramHead.aspx/GetExamPattern",
    ...
    if ($('#ctl00_ContentPlaceHolder1_ddlExamPattern').val() != "0") {
        try {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url : localurl + "Exam/GradeApprovalDean.aspx/GetExamName",
                data: JSON.stringify(Obj),
                dataType: "json",
                beforeSend: function () { $("[id*=preloader]").show(); },
                contentType: "application/json;charset=utf-8",
...
function Approvalmarkdata()
{
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url : localurl + "Exam/GradeApprovalDean.aspx/GetData",
        data: JSON.stringify(Obj),
        dataType: "json",
        beforeSend: function () { $("[id*=preloader]").show(); },
        complete: function () { $("[id*=preloader]").hide(); },
            ...
            if (response.d == '') {
                ...
                $.each(response.d, function (index, GetValue) {
                    ...
                    if (GetValue.Substatus=='NP'){
                        ...
                        str = str + '<td><input type="button" class="btn btn-sm btn-outline-primary" tabindex="0" value="Release Grades" onclick="SubmitRelease(this)" id="btnSubmitDean" /></td>'
                    }
                    else
                    { 
...
function StdList(ClickValue) { 
    ...
    if (ClickValue.classList.contains('bi-plus-square')) {
        ...
        try {
            ...
            ObjSutlist.strSchemno =  0;
            ObjSutlist.strSemesterNo = 0;
            ObjSutlist.strTecharID = $("[id*=hdnteacherid]", td).val();
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url : localurl + "Exam/GradeApprovalDean.aspx/StudentList",
...
function EditModeration(ClickValue) {  
    ...
    $.ajax({ 
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url : localurl +"Exam/GradeApprovalDean.aspx/CheckWightagesBind",
...
$(document).ready(function() {
    ...
    $("#btnmodupdate").click(function() {
        ...
        try {   
            ...
            $.ajax({
                url : localurl +"Exam/GradeApprovalDean.aspx/SubmitModeration",
                type: "POST",
                data: JSON.stringify(Obj),
                dataType: "json",
                beforeSend: function () { $("[id*=preloader]").show(); },
            ...
            $.ajax({
                ...
                success: function (response) {   
                    ...
                    { 
                        Swal.fire(
                          'Submitted!',
                          'Grade Encoding has been Release for students.',
                          'success'
                            )
                        Approvalmarkdata();
                        $("[id*=preloader]").hide();
...
function HODExcel(ClickValue) {  
    ...
    ObjExcel.strSchemno =  0;
    ObjExcel.strSemesterNo = 0;
